...
class PropertyCreate(BaseModel):
    ...
    address_neighborhood: str = Field(..., example="Jurerê Internacional")
    address_city: str = Field(..., example="Florianópolis")
    address_state: str = Field(..., pattern=r"^[A-Za-z]{2}$", example="SC")
    country: str = Field(..., pattern=r"^[A-Za-z]{2}$", example="BR")
    rooms: int = Field(..., gt=0, example=3)
